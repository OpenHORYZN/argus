...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1735469769;
...
impl SseDecode for crate::api::mission::FlutterControlRequest {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        return match inner {
            0 => crate::api::mission::FlutterControlRequest::FetchMissionPlan,
            _ => unreachable!("Invalid variant for FlutterControlRequest: {}", inner),
        };
    }
}
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        5 => wire__crate__api__mission__CoreConnection_init_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__mission__CoreConnection_send_control_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        7 => wire__crate__api__mission__CoreConnection_send_mission_plan_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        8 => wire__crate__api__mission__init_app_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
impl flutter_rust_bridge::IntoDart for crate::api::mission::FlutterControlRequest {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            Self::FetchMissionPlan => 0.into_dart(),
            _ => unreachable!(),
        }
    }
}
...
impl SseEncode for crate::api::mission::FlutterControlRequest {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(
            match self {
                crate::api::mission::FlutterControlRequest::FetchMissionPlan => 0,
                _ => {
                    unimplemented!("");
                }
            },
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        match self {
            crate::api::mission::FlutterControlResponse::SendMissionPlan(field0) => {
                ...
                <Vec<crate::api::mission::FlutterMissionNode>>::sse_encode(field0, serializer);
            }
            _ => {
                unimplemented!("");
            }
